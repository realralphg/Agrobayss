<template>
  <div class="hold container">
    <form enctype="multipart/form-data" id="form" @submit.prevent="createItem">
      <div class="row">
        <input
          v-model="form.food_bag_id"
          name="food_bag_id"
          type="number"
          id="fancy-text"
        />
        <label for="fancy-text">Food Bag ID</label>
      </div>
      <div class="row">
        <input v-model="form.name" name="name" type="text" id="fancy-text" />
        <label for="fancy-text">Name</label>
      </div>
      <div class="row">
        <input type="file" name="image" @change="onChange" id="fancy-text" />
        <label for="fancy-text">Image</label>
      </div>
      ...
      <div class="row">
        <input
          ...
          id="fancy-text"
        />
        <label for="fancy-text">Weight</label>
      </div>
    ...
    <table class="table table-hover table-bordered" id="example">
      <thead>
        <tr>
          <th class="form-control">Food Bag ID</th>
          <th class="form-control">Name</th>
          <th class="form-control">Image</th>
          <th class="form-control">Weight</th>
...
export default {
  mounted() {
    $("#example").DataTable({
      ...helpers.ajaxData("admin/foodbags/foods"),
      dom: "Bfrtip",
      buttons: ["copy", "csv", "print", "add", "Update", "delete"],

      columns: [
        { data: "food_bag_id", name: "food_bag_id" },
        { data: "name", name: "name" },
  ...
  methods: {
    ...
    async createItem() {
      ...
      await api.post("admin/foodbags/foods", formData).then(() => {
