  ...
  <div class="hold container">
    <form @submit.prevent="createItem">
      <div class="row">
        ...
        <label for="fancy-text">Items</label>
      </div>
...
export default {
  mounted() {
    $("#example").DataTable({
      ...helpers.ajaxData("admin/categories/fruitbay"),
      dom: "Bfrtip",
  ...
  methods: {
    async createItem() {
      await api.post("admin/categories/fruitbay", this.form).then(() => {
